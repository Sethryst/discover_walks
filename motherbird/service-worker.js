...
const APP_CACHE = 'walk-wildlife-shell-v187'; // Licensed archive, CC0 catalog, radio controls, and SoundCloud track selection
...
const shell = [
  ...['anchor', 'book-open', 'bookmark', 'coffee', 'download', 'droplet', 'eye', 'globe', 'newspaper', 'star', 'tree', 'walk', 'navigation', 'search'].map((icon) => `./icons/${icon}.svg`),
