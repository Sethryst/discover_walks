...
const APP_CACHE = 'walk-wildlife-shell-v117'; // bump when shell assets change
...
const shell = [
  ...
  './js/entitlements.js', './js/cloud-journal.js', './js/events.js', './js/explore.js', './js/field-edition-loader.js', './js/field-guide.js', './js/messenger-bird.js', './js/maps-folders.js', './js/learn-change.js', './js/learn-explore.js', './js/learn-folders.js', './js/learn-history.js', './js/news-map.js', './js/search.js', './js/geo.js', './js/geofence.js',
  ...
  './js/osm-regions.js', './js/national-poi-map.js', './js/national-osm-layers.js', './js/offline-routing-package.mjs', './js/walking-cell-registry.js', './js/walking-cell-cache.js', './js/walking-cell-runtime.js', './js/personal-edge-scores.js', './js/geo-cypher.js',
