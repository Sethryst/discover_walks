...
export const DC_SOURCES = [
  {
    id: 'dc_dpr_parks', title: 'Parks and Recreation Areas', cacheFile: 'data/dc-raw/parks.geojson', category: 'park', tags: ['park'],
  ...
  {
    id: 'dc_heritage_trail_signs', title: 'Heritage Trail Signs and Plaques', cacheFile: 'data/dc-raw/trails.geojson', category: 'trail', tags: ['trail', 'history'],
  ...
  {
    id: 'dc_museums', title: 'Museums', cacheFile: 'data/dc-raw/museums.geojson', category: 'history', tags: ['history'],
  ...
  {
    id: 'dc_public_art', title: 'Public Art snapshot', cacheFile: 'data/dc-raw/public_art.geojson', category: 'public_art', tags: ['public_art'],
  ...
  {
    id: 'dc_boundary_stones', title: 'Washington DC Historic Boundary Stones', cacheFile: 'data/dc-raw/boundary_stones.geojson', category: 'history', tags: ['history'],
  ...
  {
    id: 'dc_wifi', title: 'Wireless Hotspots from DC Government', cacheFile: 'data/dc-raw/wifi.geojson', category: 'wifi', tags: ['wifi'],
...
export const NEIGHBORHOOD_SOURCE = {
  id: 'dc_neighborhood_clusters', title: 'Neighborhood Clusters', cacheFile: 'data/dc-raw/neighborhood_clusters.geojson',
