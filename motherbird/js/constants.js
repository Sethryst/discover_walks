  ...
  vienna: {
    ...
    journeyFile: './data/vienna-trails.json', supplementalPoiFiles: ['./data/vienna-osm-poi.json'],
  ...
  norfolk: {
    ...
    supplementalPoiFiles: ['./data/norfolk-osm-poi.json'],
  ...
  newyork: {
    ...
    supplementalPoiFiles: ['./data/newyork-osm-poi.json'],
  ...
  philadelphia: {
    ...
    supplementalPoiFiles: ['./data/philadelphia-osm-poi.json'],
