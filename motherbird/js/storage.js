  ...
  function open() {
    return new Promise((resolve, reject) => {
      ...
      request.onupgradeneeded = () => {
        ...
        if (!database.objectStoreNames.contains('journal_audio')) database.createObjectStore('journal_audio', { keyPath: 'id' });
        if (!database.objectStoreNames.contains('county_additions')) database.createObjectStore('county_additions', { keyPath: 'id' });
