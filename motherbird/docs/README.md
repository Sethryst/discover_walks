...
17. [GeoCypher.md](GeoCypher.md) documents Audio Notes (the former Geo Cypher implementation), signed lineage, Bird Note sharing, and the Field Edition boundary.
